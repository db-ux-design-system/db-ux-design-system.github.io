...
```` kotlin
import com.example.myapplication.theme.DesignSystemTheme
...
...
Text(
    text = "Headline",
    style = DesignSystemTheme.typography.h1,
    color = DesignSystem.colors.neutral.onBgBasicEmphasis100,
    modifier = Modifier.padding(DesignSystem.dimensions.spacing.fixedMd)
)
````
