...
const getStatusBadge = (status?: string) => {
	...
	return (
		<DBBadge semantic={config.semantic as any} size="small" className="nav-item-badge">
			{config.label}
		</DBBadge>
	);
};
...
const NavItem = ({
	...
	if (externalUrl) {
		return (
			...
			>
				<a href={externalUrl} target="_blank" rel="noopener noreferrer" className="nav-item-link">
					{title}
					{lockIcon}
				</a>
			</DBNavigationItem>
