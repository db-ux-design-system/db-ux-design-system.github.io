...
<DBSection id="content-status--overview" spacing="small" width="large">
...
<DBCard data-density="expressive" className="content-status-card" spacing="large">
...
<DBSection id="content-status--concept" spacing="small" width="large">
...
<DBCard spacing='large' className="content-status-section-card" data-color="warning">
### What to expect
...
<DBCard spacing='large' className="content-status-section-card" data-color="informational">
### What to expect
...
<DBCard spacing='large' className="content-status-section-card" data-color="successful">
### What to expect
...
<DBCard spacing='large' className="content-status-section-card" data-color="critical">
### What to expect
...
<DBCard spacing='large' className="content-status-section-card" elevationLevel='2'>
### What to expect
...
<DBSection id="content-status--related-content" spacing="small" width="large">
