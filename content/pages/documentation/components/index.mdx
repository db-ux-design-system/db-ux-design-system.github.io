...
<TeaserCard
	teasers={[
		...
		{
			title: 'ControlPanel',
			description: 'Configurable toolbar combining brand, navigation, and action areas.',
		...
		{
			title: 'Shell',
			description: 'Outermost application frame combining ControlPanel and content area.',
